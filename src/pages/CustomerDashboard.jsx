...
const CustomerDashboard = () => {
    ...
    return (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            {/* Welcome Banner */}
            <div className="bg-gradient-to-br from-erp-accent to-erp-accent/80 rounded-[2.5rem] p-8 md:p-12 text-white shadow-xl relative overflow-hidden flex flex-col items-center">
                ...
                <div className="relative z-10 max-w-3xl flex flex-col items-center">
                    ...
                    <p className="text-erp-accent/10 text-lg font-medium opacity-90 max-w-xl">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
                <div className="bg-white p-8 rounded-[2rem] shadow-sm border border-gray-100">
                    <h3 className="text-lg font-black text-gray-800 tracking-tight mb-6 flex items-center gap-2">
                        <Icon icon="mdi:card-account-details-outline" className="text-erp-accent text-2xl" />
                        Account Details
                    </h3>
